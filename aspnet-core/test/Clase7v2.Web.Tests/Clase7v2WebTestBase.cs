...
{
    public abstract class Clase7v2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Clase7v2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Clase7v2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Clase7v2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Clase7v2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Clase7v2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Clase7v2DbContext, Task<T>> func)
        {
            T result;
