...
namespace Clase7v2.Migrations
{
    ...
    [Migration("20220130061649_AddProtuct")]
    partial class AddProtuct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clase7v2.Domain.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Clase7v2.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Clase7v2.Authorization.Users.User", null)
                        .WithMany("Claims")
